...
public final class PhoneNumberFactory extends RandomNumberFactory {
    ...
    public static PhoneNumber[] createRandomPhoneNumberArray(int phoneNumberCount) {
        ...
        arrayOfPhoneNumbers[0] = createRandomPhoneNumber();
        for(int i = 0; i < phoneNumberCount; i++){
                 arrayOfPhoneNumbers[i] = createRandomPhoneNumber();
        }
    ...
    public static PhoneNumber createPhoneNumberSafely(int areaCode, int centralOfficeCode, int phoneLineCode) {
        ...
        try {
            ...
            logger.debug( phoneNumber + " Is not a vaild phone number");
    ...
    public static PhoneNumber createPhoneNumber(String phoneNumberString)throws InvalidPhoneNumberFormatException {
        ...
        logger.info(" Creating a new phone number" + phoneNumberString);
